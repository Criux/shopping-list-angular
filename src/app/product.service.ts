...
export class ProductService {
    ...
    readProducts(): Observable<Product[]>{
        ...
        return this._http
            .get("http://lerngruppe.marinos.xyz/api/product/read.php")
...
createProduct(product): Observable<Product>{
    ...
    return this._http.post(
        "http://lerngruppe.marinos.xyz/api/product/create.php",
        product,
        options
        ).pipe(map((res: Response) => res.json()));
    }
...
readOneProduct(product_id): Observable<Product>{
    return this._http
        .get("http://lerngruppe.marinos.xyz/api/product/read_one.php?id="+product_id)
        .pipe(map((res: Response) => res.json()));
}
...
updateProduct(product): Observable<Product>{
    ...
    return this._http.post(
        "http://lerngruppe.marinos.xyz/api/product/update.php",
        product,
        options
    ).pipe(map((res: Response) => res.json()));
}
...
deleteProduct(product_id){
    ...
    return this._http.post(
        "http://lerngruppe.marinos.xyz/api/product/delete.php",
        { id: product_id },
        options
    ).pipe(map((res: Response) => res.json()));
}
